...
wt.exe -pwt -d . powershell -NoExit -ExecutionPolicy Unrestricted -Command ".\_watchdog.ps1" ";" split-pane -s 0.7 -H -p "Ubuntu" -d . wsl --shell-type standard -- ./_part.sh ";" split-pane -V -p "Ubuntu" -d . wsl --shell-type standard -- ./_full.sh
